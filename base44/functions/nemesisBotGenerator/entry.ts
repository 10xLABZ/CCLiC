// Nemesis bot generator — inline compact version
const NEMESIS_NAMES = {
...
export const generateNemesisBots = () => {
  ...
  for (let i = 0; i < CITIES.length; i++) {
    ...
    nemesisBots.push({ id: `nemesis_${i}`, city, state, username, profile_image_url: profileImg, player_level: level, player_power: power, bot_wins: wins, bot_losses: losses, is_nemesis: true, next_victory_at: nextVictoryAt });
  }
  return nemesisBots;
};