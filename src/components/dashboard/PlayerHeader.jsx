...
export default function PlayerHeader({ playerData, onUpdate }) {
  ...
  const handleUsernameEdit = () => {
    const newName = prompt("Enter your username:", playerData.username || "");
    if (newName !== null && newName.trim() !== "") {
      const updated = savePlayerData({ username: newName.trim() });
      onUpdate(updated);
    }
  };
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="flex-1 min-w-0">
          <button
            ...
            className="text-sm font-semibold text-slate-200 hover:text-emerald-400 transition-colors mb-0.5 block truncate max-w-full text-left"
          >
